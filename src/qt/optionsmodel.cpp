...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeDigitalsystemAmount"))
        settings.setValue("nAnonymizeDigitalsystemAmount", 1000);
    nAnonymizeDigitalsystemAmount = settings.value("nAnonymizeDigitalsystemAmount").toLongLong();
    if (settings.contains("nDarksendRounds"))
        SoftSetArg("-darksendrounds", settings.value("nDarksendRounds").toString().toStdString());
    if (settings.contains("nAnonymizeDigitalsystemAmount"))
        SoftSetArg("-anonymizeDigitalsystemamount", settings.value("nAnonymizeDigitalsystemAmount").toString().toStdString());
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizeDigitalsystemAmount:
            return QVariant(nAnonymizeDigitalsystemAmount);
        case UseBlackTheme:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizeDigitalsystemAmount:
            nAnonymizeDigitalsystemAmount = value.toInt();
            settings.setValue("nAnonymizeDigitalsystemAmount", nAnonymizeDigitalsystemAmount);
            emit AnonymizeDigitalsystemAmountChanged(nAnonymizeDigitalsystemAmount);
            break;
        default:
            break;
        }
