...
const string strMessageMagic = "Digitalsystem Signed Message:\n";
                        ...
                        bool* pfMissingInputs, bool fRejectInsaneFee, bool ignoreFees)
{
...

    {
        ...
        if (fRejectInsaneFee && nFees > MIN_RELAY_TX_FEE * 10000)
            return error("AcceptableInputs: : digitalsystem fees %s, %d > %d",
                         hash.ToString(),
...
{
    RenameThread("Digitalsystem-loadblk");
